...
class MessageUIPresenter: NSObject, Trackable {
    ...
    func presentEmailLogs() {
        ...
        emailView.setSubject("RVN Wallet Logs")
        emailView.setMessageBody("RVN Wallet Logs", isHTML: false)
        emailView.addAttachmentData(logData, mimeType: "text/plain", fileName: "rvn_logs.txt")
