//
//  StartOneTimeWipeViewController.swift
//  ravenwallet
//
...
class OnetimeWipeHeader : UIView, GradientDrawable {
    override func draw(_ rect: CGRect) {
        drawGradient(rect)
    }
}

class StartOneTimeWipeViewController : UIViewController {
    ...
    private func setInitialData() {
        ...
        message.text = S.OneTimeWipe.startMessage
        warning.text = S.OneTimeWipe.startWarning
