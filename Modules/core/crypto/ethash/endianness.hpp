...
struct le
{
    ...
    static const ethash_hash1024& uint32s(const ethash_hash1024& h) noexcept { return h; }
    static const ethash_hash512& uint32s(const ethash_hash512& h) noexcept { return h; }
    static const ethash_hash256& uint32s(const ethash_hash256& h) noexcept { return h; }
};
